...
export function buildHardOutreachRules() {
  ...
  return [
    ...
    "Use the selected research finding as the primary evidence-backed observation and connect it to one owner stake. If operatorContext contains a relevant firsthand observation from My Notes, you may naturally combine at most one such operator observation with the selected finding when it materially strengthens the message. Operator observations supplement message wording only; they do not replace the selected finding, select a new outreach angle, or change qualification or priority.",
